...
PREFIX = 'nantic'
MODULE2PREFIX = {'html_report': 'trytonspain'}
OWNER = {
    'nantic':'NaN-tic',
    'trytonzz':'nanticzz',
}
...
requires += [get_require_version('trytond_production')]
...
setup(name='%s_%s' % (PREFIX, MODULE),
    ...
    download_url='https://github.com:NaN-tic/trytond-production_traceability_report',
    ...
    project_urls = {
       "Source Code": 'https://github.com:NaN-tic/trytond-production_traceability_report'
    },
    classifiers=[
